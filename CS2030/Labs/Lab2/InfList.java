...
public interface InfList<T> {
        ...
        return new InfList<T>() {
            ...
            public <R> InfList<R> flatMap(Function<? super T, 
                ...
                return InfList.<R>of(() -> this.get().map(mapper) // Maybe<InfList<R>>
                        ...
                        .orElseGet(() -> this.next().flatMap(mapper)));
    ...
    /**
     * Creates a lazily concatenated infinite list whose elements are all
     * the elements of this list followed by all the elements of the
     * other list.
     *
     * This method is for internal use only.
     * @hidden
