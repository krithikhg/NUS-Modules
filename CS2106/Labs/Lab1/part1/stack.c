...
int add(int val, int input) { return val + input; }

int multiply(int val, int input) { return val * input; }
...
// POST: op is called with each element of the stack as first argument and value
// as second argument for each
